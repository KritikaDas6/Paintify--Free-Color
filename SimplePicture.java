...
public class SimplePicture implements DigitalPicture {
    ...
    /**
     * A Constructor that takes no arguments. It creates a picture with a width of
     * 200 and a height of 100 that is all white. A no-argument constructor must be
     * given in order for a class to be able to be subclassed. By default all
     * subclasses will implicitly call this in their parent's no-argument
     * constructor unless a different call to super() is explicitly made as the
    ...
    public void explore() {
        ...
        PictureExplorer.getInstance(this);
    }
    ...
    /**
     * Method to create a new picture by scaling the current picture by the given x
     * and y factors
     * 
    ...
    /**
     * Method to create a new picture of the passed width. The aspect ratio of the
     * width and height will stay the same.
     * 
     * @param width the desired width
     * @return the resulting picture
     */
    ...
    /**
     * Method to create a new picture of the passed height. The aspect ratio of the
     * width and height will stay the same.
     * 
     * @param height the desired height
     * @return the resulting picture
